...
const ItemDetails = ({ items, handleItemChange, addItem, removeItem }) => {
  return (
    <div className="mb-6">
      <h2 className="text-2xl font-semibold mb-4">{t("Item Details")}</h2>
      ...
      <Button type="button" onClick={addItem} className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">{t("Add Item")}</Button>
    </div>
  );
};
